                        ...
                        <div class="box-body no-padding">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><c:out value="${vehicle.nbPlace}" /></td>
                                    <!--<td>John Doe</td>-->
                                    <td>
                                        <form method="post">
                                          ...
                                          <button type="submit" class="btn btn-danger" name="deleteVehicle" value="${vehicle.id}" onclick="return window.confirm('Attention, Cette action est irrÈversible.')" >
